...
VALUES
  ...
  ('q_eng_p1', 'course_eng_01', 'skill_eng_vocab', 'Choose the best synonym for the word "Essential":', NULL, '["Crucial", "Optional", "Dangerous", "Rare"]'::jsonb, 0, 'easy', '"Essential" means absolutely necessary or crucial.', NULL, true),

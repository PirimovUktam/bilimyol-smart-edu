...
-- 5. HELPER FUNCTION: CHECK IF CURRENT CALLER IS ADMIN
...
-- 6. ONE-TIME SECURE BOOTSTRAP RPC: CLAIM FIRST ADMIN ROLE
...
-- 8. HARDEN TEACHER INVITATION RPCS: STRICTLY REQUIRE ADMIN ROLE
